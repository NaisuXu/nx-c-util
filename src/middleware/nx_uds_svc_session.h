 ...
 */
#ifndef NX_UDS_SVC_SESSION_H
#define NX_UDS_SVC_SESSION_H
 ...
 *
 * @param  user       The @c user field of nx_uds_svc_session_reset_cfg_t.
 * @param  reset_type What was asked for; an nx_uds_reset_type_t value.
 */
typedef void (*nx_uds_svc_session_reset_do_fn)(void *user, uint8_t reset_type);
 ...
 */
typedef bool (*nx_uds_svc_session_reset_allow_fn)(void *user, uint8_t reset_type,
                                          uint8_t *nrc);
 ...
 */
typedef struct {
    nx_uds_svc_session_reset_do_fn    do_fn;    /**< Performs the reset. Required. */
    nx_uds_svc_session_reset_allow_fn allow_fn; /**< Consulted first; NULL allows every
                                         type the row lists. */
...
} nx_uds_svc_session_reset_cfg_t;
...
#define NX_UDS_SVC_SESSION_TESTER_PRESENT_SUB 0x00u
 ...
 *        @c NX_UDS_SVC_SESSION_TESTER_PRESENT_SUB, and a @c session_mask reaching every
